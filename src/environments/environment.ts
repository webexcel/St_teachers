...
export const environment = {
  ...
  pages : [
    { title: 'circulars', url: '/circulars', icon: 'assets/imgs/speakers/sms_log.png', filter: "invert(96%) sepia(27%) saturate(2344%) hue-rotate(287deg) brightness(83%) contrast(121%)",admin:'N'},
    { title: 'homework',url: '/homework', icon: 'assets/imgs/speakers/homework.png', filter:"invert(15%) sepia(100%) saturate(2860%) hue-rotate(238deg) brightness(101%) contrast(170%)",admin:'N'},
    { title: 'personalized-messages',url: '/personalized-messages', icon: 'assets/imgs/speakers/male-student.png', filter:"invert(10%) sepia(51%) saturate(5820%) hue-rotate(291deg) brightness(110%) contrast(115%)",admin:'N'},
    { title: 'attendance',url: '/attendance', icon: 'assets/imgs/speakers/attendance.png',filter:"invert(22%) sepia(32%) saturate(6676%) hue-rotate(349deg) brightness(75%) contrast(81%)",admin:'N'},
    { title: 'Flash Message',url: '/flash', icon: 'assets/imgs/speakers/flash.png',filter:"invert(77%) sepia(26%) saturate(7148%) hue-rotate(347deg) brightness(101%) contrast(98%)",admin:'Y'},
    { title: 'report-card',url: '/report-card', icon: 'assets/imgs/speakers/marks.png', filter:"invert(17%) sepia(65%) saturate(5213%) hue-rotate(337deg) brightness(85%) contrast(112%)",admin:'N'},
    { title: 'Staff',url: '/staff', icon: 'assets/imgs/speakers/training.png',filter:"invert(10%) sepia(98%) saturate(6683%) hue-rotate(247deg) brightness(62%) contrast(131%)",admin:'Y'},
    { title: 'Staff Group',url: '/staff-group', icon: 'assets/imgs/speakers/training.png',filter:"invert(67%) sepia(89%) saturate(2066%) hue-rotate(358deg) brightness(100%) contrast(111%)",admin:'Y'},
