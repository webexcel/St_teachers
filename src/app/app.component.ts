  ...
  initializeApp() {
   ...
   // this.dataservice.changeMenustatus(true)
    ...
    if(this.disPlayStudentDetail){
        ...
        this.authservice.post('getclass',data).subscribe((res:any)=>{
